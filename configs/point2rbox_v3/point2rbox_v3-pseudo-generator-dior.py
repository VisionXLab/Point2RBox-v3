_base_ = 'point2rbox_v3-1x-dior.py'
...
test_dataloader['dataset']['datasets'][0]['pipeline'] = test_pipeline
test_dataloader['dataset']['datasets'][1]['pipeline'] = test_pipeline
test_evaluator = dict(_delete_=True,
                    type='DOTAMetric',
                    metric='mAP',
                    format_only=True,
                    outfile_prefix='data/dior/point2rbox_v3_pseudo_labels')
